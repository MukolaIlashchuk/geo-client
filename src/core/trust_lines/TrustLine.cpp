...
{
    return !mContractorEthereumAddress.empty() or !mBitcoinContractorPublcKey.empty();
}
...
const string TrustLine::contractorBitcoinPubKey() const
{
    return mBitcoinContractorPublcKey;
}

void TrustLine::setContractorBtcoinPublicKey(
    const string contractorBtcoinPublicKey)
{
    mBitcoinContractorPublcKey = contractorBtcoinPublicKey;
}
