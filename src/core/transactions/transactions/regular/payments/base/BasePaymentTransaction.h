...
public:
    ...
    typedef signals::signal<void(const NodeUUID&, const SerializedEquivalent, const TrustLineAmount&)>CrossChainSignal;
    typedef signals::signal<void(
            const NodeUUID&,
            const SerializedEquivalent,
            const NodeUUID&,
            const SerializedEquivalent,
            const TrustLineAmount&)>Cross2ChainSignal;
...
public:
    ...
    mutable CrossChainSignal mCrossChainSignal;

    mutable Cross2ChainSignal mCross2ChainSignal;
