...
#include "../../../../interface/commands_interface/commands/payments/CreditUsageMultyCommand.h"
...
protected:
    ...
    CreditUsageMultyCommand::Shared mMultyCommand;
