...
#include "../../payments/exchange/PaymentExchangeHandler.h"
...
protected: // Transactions
    ...
    void launchCoordinatorPaymentCrossTransaction(
        const NodeUUID &contractorUUID,
        const SerializedEquivalent equivalent,
        const TrustLineAmount &amount);

    void launchCoordinatorPayment2CrossTransaction(
            const NodeUUID &contractorUUID,
            const SerializedEquivalent equivalent,
    ...
    void launchCoordinatorPaymentMultyTransaction(
...
protected:
    ...
    void subscribeForCrossChainPayment(
        BasePaymentTransaction::CrossChainSignal &signal);

    void subscribeForCross2ChainPayment(
...
protected:
    ...
    string selectEthereumAddress(
        SerializedEquivalent equivalent);

private:
    NodeUUID &mNodeUUID;
    string mEthereumAddress;
    string mErc20Address;
    ...
    Keystore *mKeysStore;
    PaymentExchangeHandler *mPaymentExchangeHandler;
    Logger &mLog;
