...
const size_t kEthereumSignatureHexSize = 132;
const size_t kBitcoinPublicKeyHexSize = 66;
const size_t kBitcoinTransactionIDHexSize = 64;
const size_t kBitcoinSignatureHexSize = 598;
